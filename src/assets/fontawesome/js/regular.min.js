...
!(function () {
  ...
  var o = i(
      ...
      M(L, m, { solid: "fass", regular: "fasr", light: "fasl" }),
      L)
    ),
    H =
      (i(
        ...
        M(l, m, { fass: "fa-solid", fasr: "fa-regular", fasl: "fa-light" }),
        l)
      ),
      i(
        (M((c = {}), h, {
      ...
      i(
        ...
        M(s, m, { 900: "fass", 400: "fasr", 300: "fasl" }),
        s)
      ),
      ...
      (function (c) {
        ...
        (function (c, s) {
          if (c) {
            ...
            return "Map" ===
              (l = "Object" === l && c.constructor ? c.constructor.name : l) ||
              "Set" === l
              ? Array.from(c)
              : "Arguments" === l ||
  ...
  function u(c, s, l) {
    ...
    "function" != typeof d.hooks.addPack || l
      ? (d.styles[c] = e(e({}, d.styles[c] || {}), z))
      : d.hooks.addPack(c, v(s)),
      "fas" === c && u("fa", s)
  }
  var g = {
    "trash-can": [
  ...
  !(function (c) {
    try {
      for (
        var s = arguments.length, l = new Array(1 < s ? s - 1 : 0), z = 1;
        z < s;
        z++
      )
        l[z - 1] = arguments[z]
